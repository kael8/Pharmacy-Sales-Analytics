...
<ul class="navbar-nav iq-main-menu" id="sidebar">
        ...
        <ul class="sub-nav collapse" id="horizontal-menu-staff" data-bs-parent="#sidebar">
            ...
            <li class=" nav-item ">
                <a class="nav-link {{activeRoute(route('menu-style.dualcompact'))}}"
                    ...
                    <i class="sidenav-mini-icon"> D </i>
                    <span class="item-name">Edit Staff Details</span>
                </a>
            </li>
            <li class="nav-item ">
                <a class="nav-link {{activeRoute(route('menu-style.boxed'))}}" href="{{route('menu-style.boxed')}}">
                    ...
                    <i class="sidenav-mini-icon"> B </i>
                    <span class="item-name">Delete Staff</span>
                </a>
            </li>
        ...
        <ul class="sub-nav collapse" id="horizontal-menu-sales" data-bs-parent="#sidebar">
            <li class="nav-item ">
                <a class="nav-link {{activeRoute(route('recordSale'))}}" href="{{route('recordSale')}}">
                    ...
                    <i class="sidenav-mini-icon"> H </i>
                    <span class="item-name"> Record a Sale </span>
                </a>
            </li>
            <li class=" nav-item ">
                <a class="nav-link {{activeRoute(route('viewSales'))}}" href="{{route('viewSales')}}">
                    ...
                    <i class="sidenav-mini-icon"> D </i>
                    <span class="item-name">View Sales Reports</span>
                </a>
            </li>
            <li class=" nav-item ">
                <a class="nav-link {{activeRoute(route('viewSalesInsight'))}}" href="{{route('viewSalesInsight')}}">
                    <i class="icon svg-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                    ...
                    <i class="sidenav-mini-icon"> D </i>
                    <span class="item-name">Generate Sales Insights</span>
                </a>
            </li>
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="horizontal-menu-inventory" data-bs-parent="#sidebar">
            ...
            <li class=" nav-item ">
                <a class="nav-link {{activeRoute(route('restock'))}}" href="{{route('restock')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
    ...
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu-reports" role="button"
            aria-expanded="false" aria-controls="horizontal-menu">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.4"
        ...
        <ul class="sub-nav collapse" id="horizontal-menu-reports" data-bs-parent="#sidebar">
            <li class="nav-item ">
                <a class="nav-link {{activeRoute(route('generateReport'))}}" href="{{route('generateReport')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
            ...
            <li class=" nav-item ">
                <a class="nav-link {{activeRoute(route('menu-style.dualhorizontal'))}}"
                    ...
                    <i class="sidenav-mini-icon"> D </i>
                    <span class="item-name">View Past Reports</span>
                </a>
            </li>
    ...
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu-analytics" role="button"
            aria-expanded="false" aria-controls="horizontal-menu">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.4"
        ...
        <ul class="sub-nav collapse" id="horizontal-menu-analytics" data-bs-parent="#sidebar">
            <li class="nav-item ">
                <a class="nav-link {{activeRoute(route('menu-style.horizontal'))}}"
                    href="{{route('menu-style.horizontal')}}">
                    <i class="icon">
            ...
            <li class=" nav-item ">
                <a class="nav-link {{activeRoute(route('menu-style.dualhorizontal'))}}"
                    ...
                    <i class="sidenav-mini-icon"> D </i>
                    <span class="item-name">Predictive Sales</span>
                </a>
            </li>
            ...
            <li class=" nav-item ">
                <a class="nav-link {{activeRoute(route('menu-style.dualhorizontal'))}}"
                    ...
                    <i class="sidenav-mini-icon"> D </i>
                    <span class="item-name">Analyze Sales Data</span>
                </a>
            </li>
            <li class=" nav-item ">
                <a class="nav-link {{activeRoute(route('menu-style.dualhorizontal'))}}"
                    ...
                    <i class="sidenav-mini-icon"> D </i>
                    <span class="item-name">Generate Analytics</span>
                </a>
            </li>
