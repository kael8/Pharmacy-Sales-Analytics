    ...
    <div class="row">
        <div class="col-9">
            <div class="progress-detail">
                <p class="mb-1 font-weight-bold text-primary" style="font-size: 0.9rem;">Revenue</p>
                <!-- Smaller font size -->
                <h4 id="current-revenue" style="font-size: 1.5rem;">₱0</h4>
                <!-- Smaller font size -->
                <div class="d-flex">
                    <small id="revenue-percentage-change" class="me-2" style="font-size: 0.8rem;">Change: 0%</small>
                    <!-- Smaller font size -->
                </div>
            </div>
        </div>
        <div class="col-3 d-flex flex-column align-items-end">
            <div class="dropdown">
                <a href="#" class="text-secondary dropdown-toggle" id="dropdownRevenue" data-bs-toggle="dropdown"
                ...
                <ul class="dropdown-menu dropdown-menu-end p-0 m-0" aria-labelledby="dropdownRevenue">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        async function fetchSalesCount(period) {
            ...
            try {
                const response = await fetch('{{ url('/sale/revenue') }}/' + period, {
                    method: 'GET',
                    headers: {
                ...
                const revenueElement = document.querySelector('#current-revenue');
                revenueElement.textContent = `₱${data.current_revenue}`;


                const percentageChangeElement = document.querySelector('#revenue-percentage-change');
