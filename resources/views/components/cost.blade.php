    ...
    <div class="row">
        <div class="col-9">
            <div class="progress-detail">
                ...
                <!-- Smaller font size -->
                <div class="d-flex">
                    <small id="cost-percentage-change" class="me-2" style="font-size: 0.8rem;">Change: 0%</small>
                    <!-- Smaller font size -->
                </div>
            </div>
        </div>
        <div class="col-3 d-flex flex-column align-items-end">
            <div class="dropdown">
                <a href="#" class="text-secondary dropdown-toggle" id="dropdownCost" data-bs-toggle="dropdown"
                ...
                <ul class="dropdown-menu dropdown-menu-end p-0 m-0" aria-labelledby="dropdownCost">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        async function fetchSalesCount(period) {
            ...
            try {
                const response = await fetch('{{ url('/sale/cost') }}/' + period, {
                    method: 'GET',
                    headers: {
                ...
                costElement.textContent = `₱${data.current_cost}`;


                const percentageChangeElement = document.querySelector('#cost-percentage-change');
