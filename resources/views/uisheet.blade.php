                                                    ...
                                                    <div class="col-md-4">
                                                        <svg class="bd-placeholder-img" width="100%" height="250"
                                                            ...
                                                            <rect width="100%" height="100%" fill="#868e96"></rect><text
                                                                x="50%" y="50%" fill="#dee2e6" dy=".3em">Image</text>
                                                        </svg>
                    ...
                    <div class="card iq-document-card">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane bd-heading-1 fade show active" id="content-Offcanvas-prv"
                                role="tabpanel" aria-labelledby="typo-output">
                                <div class="bd-example">
                                    <button class="btn btn-primary me-3 mb-3" type="button" data-bs-toggle="offcanvas"
                                    ...
                                    <button class="btn btn-primary me-3 mb-3" type="button" data-bs-toggle="offcanvas"
                                        data-bs-target="#offcanvasScroll" aria-controls="offcanvasScroll">Toggle Scroll
                                        offcanvas</button>
                                ...
                                <div class="bd-example">
                                    <svg class="bd-placeholder-img bd-placeholder-img-lg img-fluid" width="100%"
                                        ...
                                        <rect width="100%" height="100%" fill="#868e96"></rect><text x="50%" y="50%"
                                            fill="#dee2e6" dy=".3em">Responsive image</text>
                                    </svg>
                                </div>
                                <div class="bd-example">
